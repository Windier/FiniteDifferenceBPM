...
K = @(X,Y) rect(rho(X,Y),4*guideWaist);
...
waveguides = {@(z) curvedWaveguide(z,[-dist,0],[-dist/2,0], 0, L1, WG, 2.2e-3);
              @(z) curvedWaveguide(z,[ dist,0],[ dist/2,0], 0, L1, WG, 2.2e-3);
              @(z) curvedWaveguide(z,[-dist/2,0],[-dist/2,0], L1, L2, WG, 2.2e-3);
              @(z) curvedWaveguide(z,[ dist/2,0],[ dist/2,0], L1, L2, WG, 2.2e-3);
              @(z) curvedWaveguide(z,[-dist/2,0],[-dist,0], L1+L2, zFinal-L2-L1, WG, 2.2e-3);
              @(z) curvedWaveguide(z,[ dist/2,0],[ dist,0], L1+L2, zFinal-L2-L1, WG, 2.2e-3);};
